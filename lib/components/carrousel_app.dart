...
import 'package:shopping_app_flutter/components/app_assets.dart';
import 'package:shopping_app_flutter/components/app_theme.dart';

class CarrouselPages extends StatelessWidget {
              ...
              children: List.generate(
                ...
                (index) => AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: PageCarrousel.primaryColor),
                  ),
                ),
              ),
            ),
